FusedCouncil = LibStub("AceAddon-3.0"):NewAddon("FusedCouncilAlpha","AceConsole-3.0", "AceEvent-3.0", "AceComm-3.0", "AceSerializer-3.0", "AceHook-3.0", "AceTimer-3.0");
...
function FusedCouncil:OnInitialize()
	...
	self.db = LibStub("AceDB-3.0"):New("FC_AlphaDB",dbDefaults, true);
...
function FusedCouncil:OnEnable()
	...
	LibStub("AceConfigDialog-3.0"):AddToBlizOptions("FusedCouncil Options", "FusedCouncilAlpha", nil, 'global');
